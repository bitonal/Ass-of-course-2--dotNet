...
function initialize(){
    if (localStorage.getItem("myData") ===null){
        //alert("inside if")
        myData = [new Deal(1,"Gucci","Teen Tops Project","Lana",5000),
        new Deal(2,"Victoria secret","Golden Elegance Project","Hani",110000),
...
function CreateTableFromJSON() {    
    ...
    <td><button onclick="DeleteRow(${value.dealId})"> <img src="wist.png" width="50""> </button></td>
  </tr>`);
    })
}
function AddNewDeal() {
